      ...
      <div className="absolute top-4 right-4">
        <label className="inline-flex items-center relative">
          ...
          <svg
            ...
            className="fill-white peer-checked:opacity-60 absolute w-4 h-4 left-[8px] sm:w-6 sm:h-6 sm:left-[13px]"
          >
          ...
          <svg
            ...
            id="Layer_1"
            xmlns="http://www.w3.org/2000/svg"
            className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-4 h-4 right-[8px] sm:w-6 sm:h-6 sm:right-[13px]"
          >
